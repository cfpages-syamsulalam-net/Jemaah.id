...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    alert(isLogin ? 'Login berhasil!' : 'Registrasi berhasil! Silakan login.')
  }
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            <div className="h-12 w-12 rounded-lg bg-primary flex items-center justify-center">
              <span className="text-white font-bold text-2xl font-display leading-none">J</span>
            </div>
            <span className="text-2xl font-display font-bold text-primary tracking-tight">Jemaah.id</span>
          </Link>
